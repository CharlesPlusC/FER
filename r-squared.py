...
all_engs = pd.concat([vid_1_eng ,vid_6_eng ,vid_7_eng ,vid_8_eng ,vid_10_eng,vid_11_eng,vid_12_eng,vid_13_eng,vid_14_eng,vid_15_eng])
all_vids = df.iloc[0:671]
#
# # # ### Shared x-axis graph###
data1 = all_vids['pos_avg_vid']
